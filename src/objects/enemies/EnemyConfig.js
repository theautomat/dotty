/**
 * EnemyConfig.js - Configuration for enemy types
...
const EnemyConfig = {
     ...
     * @param {Array} allowedTypes - Optional array of allowed enemy types
     * @returns {Object} Random enemy configuration
     */
    getRandomEnemyType(allowedTypes = null) {
