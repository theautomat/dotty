/**
 * EnemyWeapon.ts - Base class for enemy projectiles and weapons
 */
...
class EnemyWeapon extends GameObject {
    ...
    protected params: Required<EnemyWeaponParams>;
    protected velocity: THREE.Vector3;
    protected age: number;
    protected type: string;

    constructor(scene: THREE.Scene, position: THREE.Vector3, direction: THREE.Vector3, params: EnemyWeaponParams = {}) {
        super(scene);
     ...
     * @returns True if the projectile should self-destruct
     */
    hasExpired(): boolean {
     ...
     * @param collisionRadius - Radius to check for collision
     * @returns Whether a collision occurred
     */
    checkPlayerCollision(playerPosition: THREE.Vector3, collisionRadius: number = 2): boolean {
