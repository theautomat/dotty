/**
 * MiningDisplay.ts - 3D display of mining resources for the HUD
...
class MiningDisplay {
    ...
    private activeOres: OreDisplay[];
    private countIndicators: Record<string, OreDisplay>;
    private spacing: number;
    private maxOresDisplayed: number;
     ...
     */
    private createOreDisplay(type: string): OreDisplay {
     ...
     */
    private positionOres(animate: boolean = false): void {
     ...
     */
    private highlightOre(type: string): void {
