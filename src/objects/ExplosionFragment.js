...
class ExplosionFragment {
     ...
     * @param {THREE.Vector3} position - Start position for the fragment
     * @param {number} size - Size scaling factor
     * @param {Object} options - Fragment configuration options (only color is required)
     */
     ...
     * @returns {boolean} True if the fragment is still alive, false if it should be removed
     */
    update(deltaTime) {
     ...
     * @param {THREE.Vector3} position - Start position for the fragment
     * @param {number} size - Size scaling factor
     * @param {Object} options - Fragment configuration options
     * @returns {ExplosionFragment} A new explosion fragment instance
     */
    static create(position, size, options = {}) {
