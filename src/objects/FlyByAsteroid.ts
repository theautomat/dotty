...
class FlyByAsteroid extends Asteroid {
    ...
    constructor(params: Partial<AsteroidParams> = {}) {
     ...
     */
    updateTrajectory(playerPosition: THREE.Vector3): void {
     ...
     * @param playerPosition - Optional player position for trajectory
     * @returns True if still active, false if it should be removed
     */
    update(playerPosition: THREE.Vector3 | null = null): boolean {
