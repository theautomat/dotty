/**
 * PowerUpConfig.ts - Configuration for power-up types in the game
 */
...
export type PowerUpGeometryType =
...
export interface PowerUpDefinition {
  ...
  duration: number;
  size: number;
  geometryType: PowerUpGeometryType;
}

interface PowerUpConfigType {
  powerUpTypes: PowerUpDefinition[];
  getPowerUpConfig(type: PowerUpType | string): PowerUpDefinition | undefined;
  getRandomPowerUpType(): PowerUpDefinition;
}

const PowerUpConfig: PowerUpConfigType = {
