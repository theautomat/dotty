/**
 * CollectibleConfig.ts - Configuration for collectible types in the game
 *
...
export type CollectibleType = 'iron' | 'copper' | 'silver' | 'gold' | 'platinum';

export type GeometryType = 'tetrahedron' | 'box' | 'dodecahedron' | 'sphere' | 'torusKnot';
...
interface CollectibleConfigType {
  collectibleTypes: CollectibleDefinition[];
  getCollectibleConfig(type: CollectibleType | string): CollectibleDefinition | undefined;
  getCollectibleByIndex(index: number): CollectibleDefinition;
}

const CollectibleConfig: CollectibleConfigType = {
