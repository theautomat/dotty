...
// Mock hidden treasure data
export const mockHiddenTreasures: HiddenTreasure[] = [
  {
    id: '1',
    hiddenBy: 'CryptoWhale',
    walletAddress: '7xKXtg2CW87d97TXJSDpbD5jBkheTqA83TZRuJosgAsU',
    amount: 10000,
    tokenType: 'PEPE',
    hiddenAt: '2025-01-15T10:30:00Z',
    status: 'active',
    hiddenLocation: { x: 42, y: 128 },
    monsterType: 'Dragon',
    monsterEmoji: '🐉',
  ...
  },
  {
    ...
    amount: 5000,
    tokenType: 'BONK',
    hiddenAt: '2025-01-16T14:20:00Z',
    claimDate: '2025-01-18T09:30:00Z',
    status: 'claimed',
    hiddenLocation: { x: 88, y: 64 },
    monsterType: 'Goblin',
    monsterEmoji: '👺',
  ...
  },
  {
    ...
    amount: 25000,
    tokenType: 'WIF',
    hiddenAt: '2025-01-17T08:15:00Z',
    status: 'active',
    hiddenLocation: { x: 156, y: 92 },
    monsterType: 'Phoenix',
    monsterEmoji: '🔥',
  ...
  },
  {
    ...
    amount: 15000,
    tokenType: 'PEPE',
    hiddenAt: '2025-01-19T12:00:00Z',
    status: 'active',
    hiddenLocation: { x: 72, y: 180 },
    monsterType: 'Unicorn',
    monsterEmoji: '🦄',
  ...
  },
  {
    ...
    amount: 8000,
    tokenType: 'BONK',
    hiddenAt: '2025-01-20T09:30:00Z',
    status: 'active',
    hiddenLocation: { x: 112, y: 156 },
    monsterType: 'Dragon',
    monsterEmoji: '🐉',
  ...
  },
  {
    ...
    amount: 1200,
    tokenType: 'SOL',
    hiddenAt: '2025-01-21T15:20:00Z',
    claimDate: '2025-01-22T10:45:00Z',
    status: 'claimed',
    hiddenLocation: { x: 56, y: 220 },
    monsterType: 'Goblin',
    monsterEmoji: '👺',
  ...
  {
    id: '8',
    hiddenBy: 'NFTCollector',
    walletAddress: 'LvUa3m9Ob87d97TXJSDpbD5jBkheTqA83TZRuJosgGcB',
    amount: 30000,
    tokenType: 'WIF',
    hiddenAt: '2025-01-22T11:10:00Z',
    status: 'active',
    hiddenLocation: { x: 184, y: 104 },
    monsterType: 'Phoenix',
    monsterEmoji: '🔥',
  ...
  },
  {
    ...
    amount: 2500,
    tokenType: 'USDC',
    hiddenAt: '2025-01-23T13:40:00Z',
    status: 'active',
    hiddenLocation: { x: 128, y: 88 },
    monsterType: 'Kraken',
    monsterEmoji: '🦑',
  ...
  },
  {
    ...
    amount: 18000,
    tokenType: 'PEPE',
    hiddenAt: '2025-01-24T10:25:00Z',
    claimDate: '2025-01-25T14:50:00Z',
    status: 'claimed',
    hiddenLocation: { x: 96, y: 136 },
    monsterType: 'Unicorn',
    monsterEmoji: '🦄',
  ...
  {
    id: '11',
    hiddenBy: 'AlphaTrader',
    walletAddress: 'OyXd6p2Re87d97TXJSDpbD5jBkheTqA83TZRuJosgJfE',
    amount: 50000,
    tokenType: 'BONK',
    hiddenAt: '2025-01-25T08:55:00Z',
    status: 'active',
    hiddenLocation: { x: 164, y: 72 },
    monsterType: 'Dragon',
    monsterEmoji: '🐉',
  ...
  {
    id: '12',
    hiddenBy: 'CryptoNinja',
    walletAddress: 'PzYe7q3Sf87d97TXJSDpbD5jBkheTqA83TZRuJosgKgF',
    amount: 3500,
    tokenType: 'SOL',
    hiddenAt: '2025-01-26T16:30:00Z',
    status: 'active',
    hiddenLocation: { x: 48, y: 192 },
    monsterType: 'Goblin',
    monsterEmoji: '👺',
  ...
  {
    id: '14',
    hiddenBy: 'TokenMaster',
    walletAddress: 'RbAg9s5Uh87d97TXJSDpbD5jBkheTqA83TZRuJosgMiH',
    amount: 7500,
    tokenType: 'USDC',
    hiddenAt: '2025-01-28T14:50:00Z',
    status: 'active',
    hiddenLocation: { x: 208, y: 148 },
    monsterType: 'Kraken',
    monsterEmoji: '🦑',
  ...
  {
    id: '15',
    hiddenBy: 'MoonMission',
    walletAddress: 'ScBh0t6Vi87d97TXJSDpbD5jBkheTqA83TZRuJosgNjI',
    amount: 22000,
    tokenType: 'PEPE',
    hiddenAt: '2025-01-29T11:35:00Z',
    status: 'active',
    hiddenLocation: { x: 80, y: 200 },
    monsterType: 'Unicorn',
    monsterEmoji: '🦄',
  ...
  },
  {
    ...
    amount: 6000,
    tokenType: 'BONK',
    hiddenAt: '2025-02-01T09:20:00Z',
    status: 'expired',
    hiddenLocation: { x: 176, y: 56 },
    monsterType: 'Dragon',
    monsterEmoji: '🐉',
...
export const getActiveTreasures = () =>
  mockHiddenTreasures.filter(t => t.status === 'active');

export const getClaimedTreasures = () =>
  mockHiddenTreasures.filter(t => t.status === 'claimed');

export const getTreasuresByToken = (tokenType: TokenType) =>
  mockHiddenTreasures.filter(t => t.tokenType === tokenType);

export const getTreasuresByStatus = (status: TreasureStatus) =>
  mockHiddenTreasures.filter(t => t.status === status);

// Get unique token types
export const getUniqueTokens = (): TokenType[] => {
  const tokens = new Set(mockHiddenTreasures.map(t => t.tokenType));
...
export const getTreasureStats = (): TreasureStats => {
  const stats: TreasureStats = {
    total: mockHiddenTreasures.length,
    active: 0,
    claimed: 0,
    expired: 0,
  ...
  mockHiddenTreasures.forEach(treasure => {
