/**
 * StartScreen.js - A 3D click-to-start interface with a retro-style mouse cursor
...
class StartScreen {
     ...
     * @param {THREE.Scene} scene - The scene to add the start screen to
     * @param {Function} onStartCallback - Function to call when user clicks to start
     */
