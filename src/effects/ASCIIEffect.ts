/**
 * ASCIIEffect.ts - Renders game objects as ASCII characters
 * Provides a retro text-based view of the game
 * Based on THREE.js AsciiEffect but customized for game-specific rendering
 */
...
class ASCIIEffect {
    ...
    private originalDomElement: HTMLCanvasElement;
    ...
    private asciiTable: HTMLTableElement;
    private canvas: HTMLCanvasElement;
    private ctx: CanvasRenderingContext2D;

    // Characters for ASCII rendering
    private defaultColorCharList: string[];
    private defaultCharList: string[];
     ...
     * @param charSet - Characters to use in ASCII rendering (from darkest to brightest)
     ...
     */
    private _calculateLetterSpacing(): number {
        let letterSpacing = 0;
    ...
    setSize(width: number, height: number): void {
        ...
        (this.asciiTable as any).cellSpacing = 0;
        (this.asciiTable as any).cellPadding = 0;
